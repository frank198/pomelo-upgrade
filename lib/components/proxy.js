...
module.exports = function(app, opts)
{
	...
	if (app.enabled('rpcDebugLog'))
	{
		...
		opts.rpcLogger = require('pomelo-logger-upgrade').getLogger('rpc-debug', __filename);
	}
 ...
 */
const genProxies = function(client, app, sinfos)
{
	let item;
 ...
 */
const hasProxy = function(client, sinfo)
{
 ...
 */
const getProxyRecords = function(app, sinfo)
{
	let records = [],
		appBase = app.getBase(),
		record;
