...
const forwardLogger = require('pomelo-logger-upgrade').getLogger('forward_log', __filename);
/**
 * Handler service.
 * Dispatch request to the relative handler.
 *
 ...
 * @return {object}             handler instance if any matches or null for match fail
 */
