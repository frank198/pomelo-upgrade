...
const Watchdog = function(app, service)
{
...
Watchdog.prototype.removeServer = function(id)
{
	...
	this.notify({action : 'removeServer',
		id     : id});
};
...
Watchdog.prototype.reconnectServer = function(server)
{
	...
	this.notifyById(server.id, {action  : 'replaceServer',
...
Watchdog.prototype.notify = function(msg)
{
	...
	const latch = countDownLatch.createCountDownLatch(count, {timeout: Constants.TIME.TIME_WAIT_COUNTDOWN}, function(isTimeout)
	{
		if (isTimeout)
		{
